...
<x-app-layout>
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{ route('admin.orders.selling.store') }}" method="POST" id="orderForm" novalidate>
                @csrf
                ...
                <div class="row g-2">
                    <div class="col-md-8">
                        ...
                        <input type="text" name="invoice_number" class="form-control form-control-sm"
                               value="{{$invoiceNumber}}"
                               placeholder="PO-XXXX" required readonly>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <select name="customer_id" id="customerSelect"
                                    class="form-select form-select-sm select-customer select2" required>
                                <option value="">Select customer</option>
                                @foreach ($customers as $customer)
                                    <option value="{{ $customer->id }}">{{ $customer->name }}</option>
                                @endforeach
                            </select>
                            {{--                                <button type="button" class="btn btn-outline-primary btn-sm" style="padding: 10px;" data-bs-toggle="modal" data-bs-target="#addCustomerModal">--}}
                    ...
                    <div class="col-md-3">
                        <label class="form-label small mb-1">Customer Address</label>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-sm align-middle mb-0" id="productsTable">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 15%;">Unit Price (in JMD)</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input name="weight_unit_id[]" class="form-control unit-selected d-none"
                                               value="" readonly/>
                                        <input name="weight_unit_name[]" class="form-control unit-name-selected"
                                               value="" readonly/>
                                        {{--                                                <select name="weight_unit_id[]" class="form-select form-select-sm unit-select" readonly>--}}
                                ...
                                <tfoot>
                                <tr class="table-info">
                                    <td colspan="4"><strong>USD to JMD
                                            (1 USD
                                            is {{ App\Models\Setting::where('key', 'usd_to_jmd_rate')->first()->value }}
                                            JMD)
                                        </strong></td>
                                    <td><input type="number" id="" name="" min="0" step="0.01" readonly
                                               class="form-control form-control-sm bg-light"
                                               value="{{ App\Models\Setting::where('key', 'usd_to_jmd_rate')->first()->value }}">
                                    </td>
                                    <td></td>
                                </tr>
                                <tr class="table-info">
                                ...
                                <tr class="table-info">
                                    ...
                                    <td><input type="number" id="payableamount" name="paid_amount"
                                               ...
                                               class="form-control form-control-sm bg-light paid-amount" value="0.00">
                                    </td>
                                    <td></td>
                                </tr>
                                </tfoot>
                ...
                <div class="row g-2 d-none">
                    ...
                    <div class="col-md-4">
                        <div class="card bg-success bg-opacity-10">
                            <div class="card-body py-2">
                                <small class="text-success">Balance Due: <span
                ...
                <div class="text-end">
                    <button type="submit" class="btn btn-primary btn-sm" id="submitBtn"><i class="fas fa-cart-plus"></i>
                        Generate Invoice
                    </button>
                </div>
            </form>
    ...
    @include('layouts.selling.partials.add-customer')
    @include('layouts.selling.js')
</x-app-layout>