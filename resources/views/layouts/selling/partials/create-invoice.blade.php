               ...
               <form action="{{ route('admin.orders.selling.store') }}" method="POST" id="orderForm" novalidate>
                    ...
                    <div class="row g-2">
                        <div class="col-md-8">
                            ...
                            <input type="text" name="invoice_number" class="form-control form-control-sm" value="{{$invoiceNumber}}"
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="customer_id" id="customerSelect" class="form-select form-select-sm select-customer select2-customer" required>
                   ...
                   <div class="card mt-2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" name="rate_per_unit[]" min="0" step="0.01"
                                                    class="form-control form-control-sm price-input" placeholder="Price" readonly
                                                    required>
                                            </td>
                                            <td>
                    ...
                    <div class="text-end">
                        <button type="submit" class="btn btn-primary btn-sm" id="submitBtn"> <i class="fas fa-cart-plus"></i> Generate Invoice</button>
                    </div>
                </form>
        </div>
    </div>
