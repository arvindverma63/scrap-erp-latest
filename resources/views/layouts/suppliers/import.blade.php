                ...
                <div class="col-md-12">
                    <div class="card shadow-sm">
                        <div class="card-header bg-primary text-white">
                            <h4 class="mb-0 text-dark">Import Supplier CSV</h4>
                        </div>
                        <div class="card-body">
                            <!-- Form -->
                            <form action="{{ route('admin.supplier.import.csv') }}" method="POST"
                            ...
                            <hr>
                            <a href="{{asset('assets/csv/suppliers_sample.xlsx')}}" class="btn btn-outline-primary btn-sm">Download
                                Sample CSV</a>
                        </div>
                    </div>
                </div>
