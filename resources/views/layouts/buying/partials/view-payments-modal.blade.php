<!-- View Payments Modal -->
<div class="modal fade" id="viewPaymentsModal{{ $order->id }}" tabindex="-1"
    aria-labelledby="viewPaymentsModalLabel{{ $order->id }}" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">

            <div class="modal-header">
                <h5 class="modal-title" id="viewPaymentsModalLabel{{ $order->id }}">
            ...
            <div class="modal-body">
                @if ($order->invoice && $order->invoice->purchasePayments->count() > 0)
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @foreach ($order->invoice->purchasePayments as $payment)
                                <tr>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th colspan="2">
                                    {{ number_format($order->invoice->purchasePayments->sum('amount'), 2) }}
                                    {{ App\Models\Setting::where('key', 'currency_symbol')->first()->value }}
                                </th>
                            </tr>
                            <tr>
