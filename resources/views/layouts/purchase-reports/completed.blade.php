<x-head title="Completed Receipt" />
    ...
    <div class="page-content">
        <div class="container-fluid role-wrapper">
            ...
            <div class="d-flex justify-content-between align-items-center page-title-box">
                <h4 class="fw-bold mb-0">Receipts (Completed)</h4>
...
{{--                </div>--}}
            ...
            {{-- <div class="card shadow-sm">
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.po.completedReport') }}">
                        <div class="row g-3">
                            <div class="col-md-3">
                                <input type="text" name="transaction_id" value="{{ request('transaction_id') }}"
                                    class="form-control" placeholder="Search Receipt number...">
                            </div>
                            <div class="col-md-3">
                                <select name="supplier_id" class="form-select">
                                    <option value="">Select Supplier</option>
                                    @foreach ($suppliers as $supplier)
                                    <option value="{{ $supplier->id }}" {{ request('supplier_id')==$supplier->id ?
                                        'selected' : '' }}>
                                        {{ $supplier->name }}
                                    </option>
                                    @endforeach
                            ...
                            <div class="col-md-12 text-end mt-2">
                                ...
                                <a href="{{ route('admin.po.completedReport') }}" class="btn btn-light btn-sm">Reset</a>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            {{-- @include('layouts.purchase-reports.pdf-modal') --}}
        </div>
    </div>
