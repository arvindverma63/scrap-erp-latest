...
{{--                    <!-- Add Order Button -->--}}
{{--                    <a href="{{ route('admin.sales.voidedReport') }}" class="btn btn-primary">--}}
...
{{--                </div>--}}
            ...
            {{-- <div class="card shadow-sm">
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.sales.voidedReport') }}">
                        <div class="row g-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-12 text-end mt-2">
                                ...
                                <a href="{{ route('admin.sales.voidedReport') }}" class="btn btn-light btn-sm">Reset</a>
                            </div>
                        </div>
                    </form>
                </div>
                                    ...
                                    <td>
                                            <span
                                                    class="badge
                                                                                        ...
                                                                                        @elseif($order->status == 'Voided') bg-warning @endif">
                                                {{ $order->status }}
                                            </span>
                                    </td>
