                ...
                <div class="info">
                    ...
                    <div class="right">
                        <table class="table  table-sm" border="0">
                            ...
                            <tr>
                                <th style="text-align:left;padding:4px;text-align: right;background:#fff">Invoice No.:</th>
                            ...
                            <tr>
                                ...
                                <td style="text-align:left;padding:4px;text-align: rightfont-weight:bold;">
                                    {{ $order->supplier->tax ?? '-' }}
                                </td>
                            </tr>
                            </tbody>
                ...
                <div class="totals">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><strong>{{ number_format($order->total_amount - $order->paid_amount, 2) }}
                                    {{App\Models\Setting::where('key', 'currency_symbol')->first()->value}}</strong>
                            </td>
                        </tr>
                    </table>
                </div>
