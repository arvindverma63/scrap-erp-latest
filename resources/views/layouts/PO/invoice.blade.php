                            ...
                            <div class="row">
                                ...
                                <div class="col-8 text-end align-self-center">
                                    ...
                                    <h5 class="mb-0 fw-semibold text-white">
                                        <span class="text-muted">Issue Date:</span> {{ $invoice->invoice_date }}
                                    </h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row row-cols-3 d-flex justify-content-md-between">
                                <div class="col-md-3">
                                    ...
                                    <h5 class="my-1 fw-semibold fs-18">{{ $invoice->purchaseOrders()->supplier()->name }}</h5>
                                    <p class="text-muted">Contact: {{ $invoice->purchaseOrders()->supplier()->phone_number }} | {{ $invoice->purchaseOrders()->supplier()->email }}</p>
                                </div>
                                <div class="col-md-3">
                                    <address class="fs-13">
                                        <strong class="fs-14">Billed To :</strong><br>
                                        {{ $invoice->purchaseOrders()->supplier()->address }}
